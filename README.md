...
DAUserName            - The username of a domain administator including the domain (i.e. domain\domainadminusername).
DAPassword            - The password to the domain administrator account specified with DAUserName.
